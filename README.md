...
⚠️ Warning: The GraphRAG Accelerator uses multiple Azure services and can incur substantial costs, it is meant to host a high-utilization API with auto-scaling and user access control.  Reference the [deployment bicep](infra/main.bicep) for further detail on the services used.
